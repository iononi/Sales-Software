 ...
 */
public class ChefQuery extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_Cocinero", "Nombre_Cocinero", "ApellidoP", "ApellidoM", "Turno"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (ctr.runQuery("SELECT * FROM cocineros")) {
                if (ctr.getRS().next()) {
                    do {
                    ...
                    JOptionPane.showMessageDialog(null, "La tabla cocineros está vacía", "Tabla vacía", JOptionPane.INFORMATION_MESSAGE);
                }
